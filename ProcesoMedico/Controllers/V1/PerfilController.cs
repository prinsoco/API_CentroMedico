...
namespace ProcesoMedico.Api.Controllers.v1
{
    ...
    public class PerfilController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create([FromBody] Perfil dto)
        {
            ...
            {
                Id = id,
                Message = id > 0 ? "Perfil registrado con exito" : "Error al registro el perfil"
            };
        ...
        public async Task<IActionResult> Update([FromBody] Perfil dto)
        {
            ...
            {
                Id = affected,
                Message = affected > 0 ? "Perfil editado con exito" : "Error al editar el perfil"
            };
            return Ok(response);
        }
        ...
        public async Task<IActionResult> GetAll([FromHeader] string? input, [FromHeader] string? combo)
        {
            ...
            return Ok(new ResponseDetails<List<Perfil>>(items?.ToList()));
        }

...
namespace ProcesoMedico.Api.Controllers.v1
{
    ...
    public class RolController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create([FromBody] Rol dto)
        {
            ...
            {
                Id = id,
                Message = id > 0 ? "Rol registrado con exito" : "Error al registro el rol"
            };
        ...
        public async Task<IActionResult> Update([FromBody] Rol dto)
        {
            ...
            {
                Id = affected,
                Message = affected > 0 ? "Rol editado con exito" : "Error al editar el rol"
            };
            return Ok(response);
        }
        ...
        public async Task<IActionResult> GetAll([FromHeader] string? input)
        {
            ...
            return Ok(new ResponseDetails<List<Rol>>(items?.ToList()));
        }
